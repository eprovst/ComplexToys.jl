...
save("box-1.png", domaincolor(z->z, 2; box=(.4,.6+.2im,:white)))
save("box-2.png", domaincolor(z->1/conj(z), 2; box=(.4,.6+.2im,:white)))
save("box-3.png", domaincolor(z->1/z, 2; box=(.4,.6+.2im,:white)))
...
save("rms-sin.png", riemannsphere(sin))
